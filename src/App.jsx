...
const LIPSYNC_MODELS = [
  { id: '', label: 'OpenArt lip-sync (défaut — crédits OpenArt)' },
  { id: 'fal-ai/bytedance/omnihuman/v1.5', label: 'OmniHuman via fal ($ 0,16/s)' },
  { id: 'fal-ai/sync-lipsync/v2', label: 'sync-lipsync v2 ($ 3/min)' },
  { id: 'fal-ai/sync-lipsync/v2/pro', label: 'sync v2 PRO ($ 5/min, gros plans)' },
